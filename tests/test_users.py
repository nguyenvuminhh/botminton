...
def test_users_crud():
    ...
    try:
        ...
        if user1:
            ...
            assert user1.is_admin == False, f"Expected is_admin False, got {user1.is_admin}"
        else:
        ...
        if user2:
            ...
            assert user2.is_admin == True, f"Expected is_admin True, got {user2.is_admin}"
        else:
        ...
        if retrieved_user:
            ...
            assert retrieved_user.is_admin == False, f"Expected is_admin False, got {retrieved_user.is_admin}"
        else:
        ...
        if updated_user:
            ...
            assert updated_user.is_admin == False, f"Expected is_admin False (unchanged), got {updated_user.is_admin}"
        else:
        ...
        for u in all_users:
            ...
            assert u.telegram_id is not None, f"User telegram_id should not be None"
        ...
        if duplicate_user:
            ...
            assert duplicate_user.is_admin == False, f"Expected original is_admin False, got {duplicate_user.is_admin}"
        else:
...
def test_users_edge_cases():
    ...
    try:
        ...
        if user2:
            ...
            assert user2.is_admin == False, f"Expected original is_admin False, got {user2.is_admin}"
        else:
            print("ℹ️  Duplicate creation returned None (also acceptable)")
        ...
        if edge_user:
            ...
            assert edge_user.is_admin == False, f"Expected is_admin False, got {edge_user.is_admin}"
